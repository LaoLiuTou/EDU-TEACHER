...
//主题色
#define main_color                  UIColorFromR_G_B(0, 125, 247, 1)
//浅色字体主题色
...
-(void)createYTStsrAlertView{
    ...
    self.repulse_label.text = @"备忘录完结";
    self.repulse_label.textColor = main_color;
    self.repulse_label.font = [UIFont systemFontOfSize:kFit(18)];
    ...
    self.repulse_content_textView.text = @"请输入完结内容...";
    self.repulse_content_textView.textColor = UIColorFromR_G_B(204, 204, 204, 1);
    self.repulse_content_textView.font = [UIFont systemFontOfSize:kFit(14)];
    //500字内
    ...
    self.repulse_cancel_button.titleLabel.font = [UIFont systemFontOfSize:kFit(16)];
    ...
    self.repulse_makeSure_button.titleLabel.font = [UIFont systemFontOfSize:kFit(16)];
...
- (void)textViewDidBeginEditing:(UITextView *)textView {
    ...
    if([textView.text isEqualToString:@"请输入完结内容..."]){
        textView.text=@"";
