...
- (GKDYHeaderView *)headerView {
    if (!_headerView) {
        _headerView = [[GKDYHeaderView alloc] initWithFrame:CGRectMake(0, 0, kWidth, kDYHeaderHeight)];
    }
    return _headerView;
}
...
- (JXCategoryTitleView *)categoryView {
    if (!_categoryView) {
        _categoryView = [[JXCategoryTitleView alloc] initWithFrame:CGRectMake(0, 0, kWidth, 40.0f)];
        ...
        btmLineView.frame = CGRectMake(0, 40 - 0.5, kWidth, 0.5);
...
- (UIScrollView *)scrollView {
    if (!_scrollView) {
        ...
        CGFloat scrollH = kHeight - kNavBarHeight - 40.0f;
